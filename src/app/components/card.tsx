...
export default function StatsCardComponent(props: IStatsCardComponent) {
    ...
    return <div tabIndex={0} className={`${getCardBackground()} p-6 text-slate-100 rounded-xl border border-slate-500 shadow-sm flex flex-col gap-2 hover:scale-105 transition duration-150 ease-in-out`}>
